...
CFSSMARTSMS::createSection( $prefix, array(
    'title'  => esc_html__('Cancelled', 'nss'),
            ...
            'tabs'          => array(
                array(
                    ...
                    'fields'    => array(
                        ...
                        array(
                            'id'         => 'cancelled_admin_pattern',
                            'type'       => 'text',
                            'title'  =>  esc_html__('Pattern Code','nss'),
                            'dependency' => array( 'cancelled_admin_activate', '==', 'true' ),
                        ),
                        array(
                            'id'     => 'cancelled_admin_options',
                            'type'   => 'fieldset',
                ...
                array(
                    ...
                    'fields'    => array(
                        array(
                            'id'         => 'cancelled_customer_activate',
                            'type'       => 'switcher',
                            'title'  =>  esc_html__('Send SMS','nss'),
                            'default' => false,
                            'text_width' => 100
                        ...
                        array(
                            'id'         => 'cancelled_customer_pattern',
                            'type'       => 'text',
                            'title'  =>  esc_html__('Pattern Code','nss'),
                            'dependency' => array( 'cancelled_customer_activate', '==', 'true' )
                        ),
                        array(
                            'id'     => 'cancelled_customer_options',
                            'type'   => 'fieldset',
                            'title'  => esc_html__('Activate the variables used in your pattern','nss'),
                            'subtitle' => esc_html__('for mellipayamak use 0 for status , 1 for order_id , 2 for customer , 3 for price and 4 for order_items ,','nss'),
                            'dependency' => array( 'cancelled_customer_activate', '==', 'true' ),
                ...
                array(
                    ...
                    'fields'    => array(
                        ...
                        array(
                            'id'         => 'cancelled_vendor_pattern',
                            'type'       => 'text',
                            'title'  =>  esc_html__('Pattern Code','nss'),
                            'dependency' => array( 'cancelled_vendor_activate', '==', 'true' )
                        ),
                        array(
                            'id'         => 'cancelled_vendor_metakey',
                            'type'       => 'select',
