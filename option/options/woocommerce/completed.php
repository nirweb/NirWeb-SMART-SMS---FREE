...
CFSSMARTSMS::createSection( $prefix, array(
    'title'  => esc_html__('Completed', 'nss'),
            ...
            'tabs'          => array(
                array(
                    ...
                    'fields'    => array(
                        ...
                        array(
                            'id'         => 'completed_admin_pattern',
                            'type'       => 'text',
                            'title'  =>  esc_html__('Pattern Code','nss'),
                            'dependency' => array( 'completed_admin_activate', '==', 'true' ),
                        ),
                        array(
                            'id'     => 'completed_admin_options',
                            'type'   => 'fieldset',
                ...
                array(
                    ...
                    'fields'    => array(
                        array(
                            'id'         => 'completed_customer_activate',
                            'type'       => 'switcher',
                            'title'  =>  esc_html__('Send SMS','nss'),
                            'default' => false,
                            'text_width' => 100
                        ...
                        array(
                            'id'         => 'completed_customer_pattern',
                            'type'       => 'text',
                            'title'  =>  esc_html__('Pattern Code','nss'),
                            'dependency' => array( 'completed_customer_activate', '==', 'true' )
                        ),
                        array(
                            'id'     => 'completed_customer_options',
                            'type'   => 'fieldset',
                            'title'  => esc_html__('Activate the variables used in your pattern','nss'),
                            'subtitle' => esc_html__('for mellipayamak use 0 for status , 1 for order_id , 2 for customer , 3 for price and 4 for order_items ,','nss'),
                            'dependency' => array( 'completed_customer_activate', '==', 'true' ),
                ...
                array(
                    ...
                    'fields'    => array(
                        ...
                        array(
                            'id'         => 'completed_vendor_pattern',
                            'type'       => 'text',
                            'title'  =>  esc_html__('Pattern Code','nss'),
                            'dependency' => array( 'completed_vendor_activate', '==', 'true' )
                        ),
                        array(
                            'id'         => 'completed_vendor_metakey',
                            'type'       => 'select',
