            ...
            'tabs'          => array(
                array(
                    ...
                    'fields'    => array(
                        ...
                        array(
                            'id'         => 'failed_admin_pattern',
                            'type'       => 'text',
                            'title'  =>  esc_html__('Pattern Code','nss'),
                            'dependency' => array( 'failed_admin_activate', '==', 'true' )
                        ),
                        array(
                            'id'     => 'failed_admin_options',
                            'type'   => 'fieldset',
                ...
                array(
                    ...
                    'fields'    => array(
                        ...
                        array(
                            'id'         => 'failed_customer_pattern',
                            'type'       => 'text',
                            'title'  =>  esc_html__('Pattern Code','nss'),
                            'dependency' => array( 'failed_customer_activate', '==', 'true' )
                        ),
                        array(
                            'id'     => 'failed_customer_options',
                            'type'   => 'fieldset',
                            'title'  => esc_html__('Activate the variables used in your pattern','nss'),
                            'subtitle' => esc_html__('for mellipayamak use 0 for status , 1 for order_id , 2 for customer , 3 for price and 4 for order_items ,','nss'),
                            'dependency' => array( 'failed_customer_activate', '==', 'true' ),
                ...
                array(
                    ...
                    'fields'    => array(
                        ...
                        array(
                            'id'         => 'failed_vendor_pattern',
                            'type'       => 'text',
                            'title'  =>  esc_html__('Pattern Code','nss'),
                            'dependency' => array( 'failed_vendor_activate', '==', 'true' )
                        ),
                        array(
                            'id'         => 'failed_vendor_metakey',
                            'type'       => 'select',
