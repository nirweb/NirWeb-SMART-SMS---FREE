...
(function($) {
  ...
  CSFAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('CFSSMARTSMS-chosen', _this.options.data).done( function( response ) {
  ...
  CSFAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.CFSSMARTSMS-hide-select');
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('CFSSMARTSMS-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('CFSSMARTSMS-depend-on');
        });
