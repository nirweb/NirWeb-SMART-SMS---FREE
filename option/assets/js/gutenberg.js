...
( function( blocks, blockEditor, element, components ) {
  ...
  Object.values(window.csf_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType('CFSSMARTSMS-gutenberg-block/block-'+block.hash, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'CFSSMARTSMS-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.hash,
              className: 'is-secondary CFSSMARTSMS-shortcode-button',
              onClick: function () {
